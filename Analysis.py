...
data = pd.read_csv("C:\\Users\\BCS\\Desktop\\SMART WATCH ANALYSIS\\dailyActivity_merged.csv")
print(data.head())
...
#combine all the minutes columns as total minutes before moving forward
...
# to find the weekdays of the records and add a new column to this dataset as “Day”
